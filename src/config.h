...
// --- FIRMWARE METADATA ---
#define OPENLITTER_VERSION  "0.3.0"
...
#define CYCLE_DUMP_PAUSE_SEC      3   // Seconds to PAUSE (motor off) at DUMP during a cleaning cycle so waste falls through the door before the CW return
